...
public class Updatedata extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{ 
		    ...
		    PreparedStatement st = con.prepareStatement("update account set accno=?,age=?,dob=?,email=?,pno=? where name=?");  
		    
		     
		     st.setInt(1, Integer.valueOf(request.getParameter("number")));
		     ...
		     st.setInt(5, Integer.valueOf(request.getParameter("pno")));
